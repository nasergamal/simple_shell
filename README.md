# Simple shell
## Intro
This is a project assigned to us by the ALX software engineering program. The objectives for this project is to teach collaboration and create our own simple shell.
